...
public class FoundActivity extends AppCompatActivity {
   ...
   back.setOnClickListener(new View.OnClickListener() {
       ...
       public void onClick(View v) {
           startActivity(new Intent(FoundActivity.this,HomeActivity.class));
       }
   });
        ProductsRef = FirebaseDatabase.getInstance().getReference().child("Found");
        layoutManager = new LinearLayoutManager(this);
        recyclerView = (RecyclerView)findViewById(R.id.recycler_menu_found);
